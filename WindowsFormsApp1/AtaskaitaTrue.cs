...
namespace PCMSystem
{
    public partial class Ataskaita_True : Form
    {
        public Ataskaita_True()
        {
            InitializeComponent();
        ...
        private void Ataskaita_Load(object sender, EventArgs e)
        {
            ...
            using (TextWriter tw = new StreamWriter("C:\\Users\\kooky\\Documents\\DOTNET\\reports\\ataskaitaTrue.txt"))
            {
